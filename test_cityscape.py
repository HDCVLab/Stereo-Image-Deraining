...
ckpt_path = './checkpoints/checkpoint_raincityscape_monocular_coarseloss_fine_epoch_200'
...
val_data_loader = DataLoader(rain_cityscape_dataset(val_data_dir, val_gtdata_dir), batch_size=1, shuffle=False, num_workers=0, drop_last=True)
